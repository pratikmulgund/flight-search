...
/**
 * The type Abstract it. This creates a test postgresql container and executes the DB migrations through liquibase to give you
 * an environment as close as production environment.
 */
@ActiveProfiles("test")
...
public abstract class AbstractIT {
    ...
    /**
     * The constant postgreDBContainer.
     */
